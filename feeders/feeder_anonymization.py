...
class Feeder(Dataset):
    ...
    def load_data(self):
        ...
        if self.debug:
            perm = np.random.choice(
                len(self.gender_label), 2000, replace=False)
            ...
            # self.gender_label = self.gender_label[0:100]
            # self.action_label = self.action_label[0:100]
    ...
    def __getitem__(self, index):
        ...
        return data_numpy, gender_label, action_label, index
